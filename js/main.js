...
// Функция для перетаскивания элементов по экрану.
// Перебираю в цикле сгенерированные фигуры с одним классом
// в функции moveAT передвигаю элементы под координаты курсора и сдвигаю на половину ширины/высоты для центрирования
// При отпускании мышки "оставляю" перенесенные элемент на новом месте
